...
pygame.display.set_caption('Breaki-IT')
...
bg = (234, 218, 184)
# block colours
block_orange = (255, 255, 0)
block_brown = (128, 0, 0)
block_gray = (105, 105, 105)
# paddle colours
...
class game_ball():
    ...
    def move(self):
        ...
        if wall_destroyed == 1 or balls_hit == 36:
            self.game_over = 1
        ...
        return self.game_over, balls_hit
...
while run:
    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            run = False
        elif event.type == pygame.KEYDOWN and event.key == pygame.K_SPACE and live_ball == True:
    ...
    if not live_ball:
        if game_over == 0:
            draw_text('     PRESS SPACE TO START', font, text_col, 100, screen_height // 2 + 100)
        elif game_over == 1:
    ...
    draw_text('SCORE: ' + str(balls_hit), font, text_col, 10, screen_height // 2 + 270)
